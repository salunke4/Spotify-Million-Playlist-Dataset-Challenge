...
TEST_CASE("Inserting Duplicate Vertices") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
...
TEST_CASE("Removing Nonexistent Vertices") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
...
TEST_CASE("InsertVertex & IsAdjacent") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
...
TEST_CASE("Inserting Duplicate Edge") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
...
TEST_CASE("Remove Nonexistent Edge") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
...
TEST_CASE("AdjacentVertices Functionality") {
  Graph graph;
  graph.InsertVertex("A");
  graph.InsertVertex("B");
  graph.InsertVertex("C");
